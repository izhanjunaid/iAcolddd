...
async function bootstrap() {
    ...
    console.log('Granting AP permissions to admin...');
    ...
    if (addedCount > 0) {
        ...
        console.log('Super Admin role already has all AP permissions.');
    }
    ...
    if (!hasRole) {
        ...
        // We need to fetch the role again cleanly or push it? 
        // roles relations are loaded eagerly in User entity? Yes, lines 70 in user.entity.ts says eager: true.
