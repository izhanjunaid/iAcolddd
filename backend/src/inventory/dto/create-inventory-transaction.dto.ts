...
export class CreateInventoryTransactionDto {
  ...
  @ApiPropertyOptional({
    example: 'uuid-here',
    description: 'ID of the customer who owns the goods',
  })
  @IsOptional()
  @IsUUID()
  customerId?: string;
  ...
  @ApiPropertyOptional({
    example: 'uuid-here',
    description: 'ID of the room within the warehouse',
  })
  @IsOptional()
  @IsUUID()
  roomId?: string;
  ...
  @ApiPropertyOptional({
    example: 'uuid-here',
    description: 'Source room ID (for transfers)',
  })
  @IsOptional()
  @IsUUID()
  fromRoomId?: string;
  ...
  @ApiPropertyOptional({
    example: 'uuid-here',
    description: 'Destination room ID (for transfers)',
  })
  @IsOptional()
  @IsUUID()
  toRoomId?: string;

  @ApiProperty({ example: 100.5, description: 'Quantity being transacted' })
  @IsNumber()
  @IsPositive()
  ...
  @ApiProperty({
    example: 25.75,
    description:
      'Cost per unit (calculated automatically for ISSUE/SALES_RETURN/CONSUMPTION transactions)',
  })
  @IsNumber()
  @ValidateIf(
    (o) =>
      o.transactionType !== InventoryTransactionType.ISSUE &&
      o.transactionType !== InventoryTransactionType.SALES_RETURN &&
      o.transactionType !== InventoryTransactionType.CONSUMPTION,
  )
  @IsPositive()
  @Transform(({ value }) => parseFloat(value))
  unitCost: number;
  ...
  @ApiPropertyOptional({
    example: 'Stock received in good condition',
  ...
  @ApiPropertyOptional({
    example: 'uuid-here',
    description: 'Expense Account ID (required for CONSUMPTION)',
  })
  @ValidateIf((o) => o.transactionType === InventoryTransactionType.CONSUMPTION)
  @IsUUID()
  @IsNotEmpty()
