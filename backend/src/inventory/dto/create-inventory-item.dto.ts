...
export class CreateInventoryItemDto {
  @ApiProperty({
    example: 'RICE001',
    description: 'Unique SKU for the inventory item',
  })
  @IsString()
  @IsNotEmpty()
  @MaxLength(50)
  ...
  @ApiPropertyOptional({
    example: 'High quality basmati rice for export',
  ...
  @ApiPropertyOptional({ example: 25.5, description: 'Standard cost per unit' })
  @IsOptional()
  @IsNumber()
  @Min(0)
  standardCost?: number;
